...
export default function MyAlbums() {
  ...
  // Reusable "Login Required" gate — same purple/indigo color scheme as before
  const authGate = useAuthGate({
    icon: Disc3,
    message:
      "Please login to view your saved albums and build your own music library.",
    pageGradient: "from-slate-50 via-purple-50/40 to-slate-50",
    cardShadow: "shadow-purple-100/50",
    ...
    buttonShadow: "shadow-purple-200 hover:shadow-xl hover:shadow-purple-300",
    showAuthModal,
    setShowAuthModal,
  });
