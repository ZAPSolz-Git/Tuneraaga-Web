...
export default function MyAlbums() {
  ...
  if (!user && !loading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-slate-50 via-purple-50/40 to-slate-50 p-4">
        <div className="relative bg-white/80 backdrop-blur-xl border border-slate-200 rounded-3xl shadow-xl shadow-purple-100/50 px-8 py-12 md:px-14 md:py-16 max-w-md w-full text-center overflow-hidden">
          {/* Decorative blurred circles */}
          <div className="absolute -top-10 -right-10 w-32 h-32 bg-purple-200/40 rounded-full blur-2xl" />
          <div className="absolute -bottom-10 -left-10 w-32 h-32 bg-indigo-200/40 rounded-full blur-2xl" />

          {/* Icon */}
          <div className="relative w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-purple-600 to-indigo-600 flex items-center justify-center shadow-lg shadow-purple-200">
            <Disc3 size={36} className="text-white" />
          </div>
          ...
          <p className="relative text-slate-500 mb-8 text-sm md:text-base leading-relaxed">
            Please login to view your saved albums and build your own music
            library.
          </p>

          <button
            onClick={() => setShowAuthModal(true)}
            className="relative w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-8 py-3.5 rounded-full font-bold shadow-lg shadow-purple-200 hover:shadow-xl hover:shadow-purple-300 hover:scale-105 active:scale-95 transition-all duration-300"
          >
            Login / Sign Up
          </button>
        </div>
